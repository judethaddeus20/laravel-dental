        ...
        <form action="{{ url('users', $user->id) }}" method="POST">
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <input id="number" class="form-control @error('number') is-invalid @enderror" name="number" value="{{ $user->number }}"></input>
              @error('number')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
          ...
          <div class="form-group">
            ...
            <input id="location" class="form-control @error('location') is-invalid @enderror" rows="2" name="location" value="{{ $user->location }}"></input>
            @error('location')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
          ...
          <div class="form-row">
            ...
            <div class="form-group col-md-4">
              ...
              <input type="text" id="age" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $user->age }}">
              @error('age')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
                  </span>
